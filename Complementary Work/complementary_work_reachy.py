...
sleep(10) # Waits for the person the choose the color card
##########################################################
...
if color[1] > color[0] and color[1] > color[2]: # The colour value of green is higher than red and blue
    user_color = "Green" 
    playsound('MP3/ElevenLabs_Green.mp3')
    print(user_color)
elif color[1] > color[2] and color[0] > color[2]: # The colour value of red and green are both higher than blue 
    user_color = "Orange"
    playsound('MP3/ElevenLabs_Orange.mp3')
    print(user_color)
else: 
    user_color = "Violet"
    playsound('MP3/ElevenLabs_Violet.mp3')
    print(user_color)
##########################################################
